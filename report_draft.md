# 観光業（OTA・Google等）におけるAIエージェント活用 総合調査レポート
...
- **Booking.com（1996年）：** オランダで設立。2005年にPricelineに買収され、ヨーロッパ市場を中心に急拡大。

2000年のドットコム崩壊で多くのスタートアップが倒産したが、生存者は2002年以降の経済回復期に急速に力をつけ、伝統的旅行代理店からの市場シェア移行を加速させた。

2008年には宿泊共有の新たな形態として**Airbnb**（Brian Chesky・Joe Gebbia・Nathan Blecharczyk創業）が登場し、民泊マーケットプレイスという革新的モデルでホテル業界に根本的な変革をもたらした。
...
- コロナ後の個人旅行（FIT：Foreign Independent Travel、手配旅行）化により、個別最適化された旅行計画へのニーズが急増
...
2. **信頼構築：** キャンセル・返金・変更時の責任範囲の明確化。エラー発生時の人間へのエスカレーション設計
